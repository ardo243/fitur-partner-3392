...
@section('title', 'Laporan Transaksi - Organisasi')
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50/50 transition {{ $trx->status == 'pending' ? 'text-slate-400' : '' }}">
                    <td class="px-8 py-6">
                        <span class="font-mono font-bold px-3 py-1 rounded-lg text-sm {{ $trx->status == 'pending' ? 'bg-slate-100' : 'text-indigo-600 bg-indigo-50 border border-indigo-100/50' }}">
                            {{ $trx->order_id }}
                        </span>
                    </td>
                    <td class="px-8 py-6">
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-8 py-16 text-center text-slate-500 font-medium">
